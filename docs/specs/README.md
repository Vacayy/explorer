...
| [차트 구조 그리기](chart-structure.md) | 종목 하나의 채널·추세선을 결정적으로 그리는 계약 — 계산·해석 규칙·API·화면 5-state | P0 구현(2026-09-21, D-195): 종목 발견 mode=draw 카드 + 기업 페이지 패널 | P1: 수평 지지·저항, 여러 종목, 구조 → 감시 규칙/검색 조건 변환, 애매한 문장 모델 보조 |

...
3. 두루뭉술한 표현은 반드시 전략으로 풀어라. "바닥 찍고 올라오는"은 20일 이평 상승반전/추세전환 확인형/단기 골든크로스/
   ...
   "요즘 많이 오르는"은 20일 대비율 상위/20일 신고가/정배열 등으로 같은 방식. 차트 구조 표현은 '가격 구조' 카테고리를 쓴다:
   "저점을 높인다"→higher_lows, "전고점 돌파"→resistance_break, "돌파 후 지지·재돌파"→breakout_retest_rebreak,
   "추세선 돌파/지지"→trendline_*, "채널 돌파/이탈"→channel_*. 사용자는 전문가가 아닐 수 있으니

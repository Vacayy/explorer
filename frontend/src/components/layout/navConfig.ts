...
import { Bookmark, Globe, House, MessageSquare, Newspaper } from "lucide-react"
 ...
 */
export type AppMode = "home" | "follow" | "feed" | "worldmodel" | "chat" | "analyze" | "us" | "archive"
...
export const MODES: readonly ModeDef[] = [
  ...
  { key: "follow", label: "팔로우", path: "/follow", icon: Bookmark, dividerBefore: true, tabs: FOLLOW_TABS },
  { key: "feed", label: "피드", path: "/feed", icon: Newspaper, tabs: FEED_TABS },

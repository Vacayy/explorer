...
import { Archive, GitCompare, ListChecks, NotebookPen, CalendarDays, Map, Filter, Bitcoin } from "lucide-react"
...
const ARCHIVED = [
  ...
  { to: "/research/watchlist", icon: ListChecks, title: "워치리스트 관리", desc: "확신도·목표가·논지 편집 (홈 사이드바로 대부분 대체됨)" },

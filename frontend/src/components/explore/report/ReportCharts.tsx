 ...
 * 차트 색은 lightweight-charts라 hex 직접(기존 관례) · bar는 semantic up/down.
 */
...
/* ① 상방/하방 비대칭 — 하방(파랑, 왼쪽) ← 0 → 상방(빨강, 오른쪽) */
            ...
            <div key={s.code} className="flex items-center gap-2 text-[11px]">
              ...
              <div className="flex flex-1 items-center">
                <div className="flex w-1/2 justify-end">
                  <div className="h-3.5 rounded-l bg-down/70" style={{ width: `${(down / scale) * 100}%` }} />
                </div>
                <div className="h-4 w-px bg-border" />
                <div className="flex w-1/2 justify-start">
                  <div className="h-3.5 rounded-r bg-up/70" style={{ width: `${(up / scale) * 100}%` }} />
                </div>
              </div>
